...
export default async function DashboardPage() {
  ...
  return <main className="content">
    <div className="page-heading"><div><div className="eyebrow">经营驾驶舱</div><h1>{user.name}，这是今天的经营重点</h1><p className="page-description">资金、未来现金流、审批和项目风险均来自实时业务数据。</p></div><div className="heading-actions"><Link className="button" href="/projects">查看项目总账</Link><Link className="button primary" href={approvalHref}>处理待审批</Link></div></div>
