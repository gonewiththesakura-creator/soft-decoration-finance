...
const groups = [
  ...
  { label: "采购", items: [{ href: "/skus", label: "SKU 明细", icon: Tags, resource: "skus" as ResourceKey }, { href: "/quotes", label: "报价与核价", icon: SearchCheck, resource: "quotes" as ResourceKey }, { href: "/purchase-requests", label: "采购申请 / 审批", icon: ClipboardCheck, resource: "purchase-requests" as ResourceKey }, { href: "/purchase-orders", label: "采购订单", icon: Truck, resource: "purchase-orders" as ResourceKey }, { href: "/returns", label: "退换货与冲销", icon: PackageCheck, resource: "returns" as ResourceKey }] },
