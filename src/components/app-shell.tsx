...
const groups = [
  ...
  { label: "系统", items: [{ href: "/imports", label: "Excel 导入", icon: FileSpreadsheet, resource: "imports" as ResourceKey }, { href: "/permissions", label: "权限", icon: LockKeyhole, resource: "users" as ResourceKey }, { href: "/audit-logs", label: "操作日志", icon: History, resource: "audit-logs" as ResourceKey }] },
];
