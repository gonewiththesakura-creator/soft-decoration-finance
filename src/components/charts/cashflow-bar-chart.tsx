...
export function CashflowBarChart({ data }: { data: Week[] }) {
  ...
  return <div className="chart-frame" role="img" aria-label="未来三十天应收与应付分周对比">
    <div className="chart-stage compact"><ResponsiveContainer width="100%" height="100%"><BarChart data={data} margin={{ top: 12, right: 8, left: 0, bottom: 0 }} barGap={4} onClick={() => router.push("/finance-workspace#execution")} style={{ cursor: "pointer" }}>
