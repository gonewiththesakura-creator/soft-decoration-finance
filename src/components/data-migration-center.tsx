...
export function DataMigrationCenter({ allowedTypes, dataMode, initialMode, isOwner }: { allowedTypes: string[]; dataMode: "real" | "demo"; initialMode: "upload" | "folder"; isOwner: boolean }) {
  ...
  return <>
    ...
    <div className="migration-stack">
      ...
      {workbook?.contextConfirmed ? <AnalysisPanel workbook={workbook} facts={facts} pendingFacts={pendingFacts} projectLabel={projectLabel} selectedSheet={selectedSheet} loading={loading} reviewFact={reviewFact} stage={() => stage(true)} /> : null}
