...
export const AI_HARDENING_MIGRATION = String.raw`
DO $migration$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM schema_migrations WHERE version = '0010_ai_hardening') THEN
    ALTER TABLE ai_runs ADD COLUMN IF NOT EXISTS primary_calls integer NOT NULL DEFAULT 0;
    ALTER TABLE ai_runs ADD COLUMN IF NOT EXISTS fast_calls integer NOT NULL DEFAULT 0;
    ALTER TABLE ai_runs ADD COLUMN IF NOT EXISTS fallback_count integer NOT NULL DEFAULT 0;
    INSERT INTO schema_migrations(version) VALUES ('0010_ai_hardening');
  END IF;
END
$migration$;
`;
...
export const EXTERNAL_INGEST_API_MIGRATION = String.raw`
DO $migration$
BEGIN
