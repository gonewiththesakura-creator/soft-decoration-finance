...
export const projects = pgTable("projects", {
  ...
  originalContractCents: integer("original_contract_cents").notNull().default(0),
  currentContractCents: integer("current_contract_cents").notNull().default(0),
...
export const skus = pgTable("skus", {
  ...
  budgetUnitCents: integer("budget_unit_cents").notNull(),
  finalUnitCents: integer("final_unit_cents"),
  supplierId: integer("supplier_id").references(() => suppliers.id),
  taxRateBps: integer("tax_rate_bps").notNull().default(1300),
  freightCents: integer("freight_cents").notNull().default(0),
  installCents: integer("install_cents").notNull().default(0),
...
export const purchaseOrders = pgTable("purchase_orders", {
  ...
  number: text("number").notNull().unique(),
  amountCents: integer("amount_cents").notNull(),
  deliveredCents: integer("delivered_cents").notNull().default(0),
